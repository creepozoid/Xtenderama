while True:
    print('Xtenderama v.0.2.0 "Power of Imperfection"')
    print('[start]')
...
Enter a number from '0' t0 '9' to select a 'C' value: ''')
    m = [1.25, 3.257, 3.417, 3.417, 3.417, -2.00, -1.838, -1.678, -1.678, -1.678, 3.417, 3.417]
    c1 = int(c1)
    c = m[c1]
...
#    drb = (d4, d6)
    if c1 == 0:
        ...
        flcdc = str('EXTF, c = 3.417')
    elif c1 == 11:
        flcdc = str('EXTM, c = 3.417')
#    import os
